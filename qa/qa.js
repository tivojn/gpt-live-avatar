...
for (const f of ['electron/main.cjs', 'electron/preload.cjs']) new vm.Script(read(f), { filename: f });
...
const preload = read('electron/preload.cjs'); const main = read('electron/main.cjs');
