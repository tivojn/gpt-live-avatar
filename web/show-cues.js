...
// "Let's go" only counts when it ends the sentence; "let's go with a comedy" is still the briefing.
const PREPARE=/\b(?:prepare|write|create|make|build|generate|start|begin|do|revise|rewrite|redo|update|fix|change) (?:the |a |our |my )?(?:show|play|script|performance)\b|\u4fee\u6539(?:\u5267\u672c|\u4e00\u4e0b)|\u91cd\u5199|\u6539(?:\u4e00\u4e0b|\u6539)?\u5267\u672c|\blet(?:'|\u2019)?s (?:go|start|begin|do it)[.!\u3002\uff01]*\s*$|\bplaces,? everyone\b|\u5f00\u59cb(?:\u51c6\u5907|\u5199\u5267\u672c|\u6f14\u51fa|\u8868\u6f14|\u5427)|\u51c6\u5907(?:\u6f14\u51fa|\u4e00\u4e0b|\u5267\u672c|\u597d\u4e86)|\u5199(?:\u4e00\u4e2a|\u4e2a)?\u5267\u672c|\u6392\u7ec3|\u5c31\u8fd9\u6837(?:\u5f00\u59cb|\u5427)/i;
